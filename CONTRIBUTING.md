# Contributing to Bubble.io Dead Code Detector

Thank you for your interest in contributing to Bubble.io Dead Code Detector! We welcome contributions of all kinds, whether you are fixing a bug, improving documentation, or proposing new features.
...
1. **Fork the repository** and clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/bubble-io-dead-code-detector.git
...
Bubble.io Dead Code Detector requires **Node.js 20+ LTS** and npm.
